...
const ownedResources = [
  ...
  { owner: "WALLET_SERVICE", name: "funding_authority.resolve_funding_instrument", kind: "rpc" },
  ...
  { owner: "COMMISSION_SERVICE", name: "compensation.configurations", kind: "table" },
  { owner: "COMMISSION_SERVICE", name: "compensation.executions", kind: "table" },
  { owner: "COMMISSION_SERVICE", name: "compensation.entitlements", kind: "table" },
  { owner: "COMMISSION_SERVICE", name: "compensation.events", kind: "table" },
  ...
  { owner: "GAME_ENGINE_SERVICE", name: "game_engine.published_draw_schedule_versions", kind: "table" },
  { owner: "GAME_ENGINE_SERVICE", name: "game_engine.draw_execution_manifests", kind: "table" },
  { owner: "GAME_ENGINE_SERVICE", name: "game_engine.canonical_draw_execution_leases", kind: "table" },
  { owner: "GAME_ENGINE_SERVICE", name: "game_engine.canonical_draw_orchestration_events", kind: "table" },
  { owner: "GAME_ENGINE_SERVICE", name: "game_engine.outcome_provider_executions", kind: "table" },
  { owner: "GAME_ENGINE_SERVICE", name: "game_engine.outcome_provider_execution_evidence", kind: "table" },
  { owner: "GAME_ENGINE_SERVICE", name: "game_engine.canonical_outcome_lifecycle_events", kind: "table" },
  { owner: "GAME_ENGINE_SERVICE", name: "game_engine.game_engine_production_activation_events", kind: "table" },
  ...
  { owner: "TICKET_SERVICE", name: "ticket_authority.availability_decisions", kind: "table" },
  { owner: "TICKET_SERVICE", name: "ticket_authority.resolve_effective_availability", kind: "rpc" },
  { owner: "TICKET_SERVICE", name: "ticket_authority.liability_decisions", kind: "table" },
  { owner: "TICKET_SERVICE", name: "ticket_authority.evaluate_liability", kind: "rpc" },
  ...
  { owner: "OPERATIONAL_SERVICE", name: "operational_governance.security_policy_versions", kind: "table" },
  { owner: "OPERATIONAL_SERVICE", name: "operational_governance.privileged_sessions", kind: "table" },
  { owner: "OPERATIONAL_SERVICE", name: "operational_governance.security_validation_evidence", kind: "table" },
  { owner: "OPERATIONAL_SERVICE", name: "operational_governance.change_policy_versions", kind: "table" },
  { owner: "OPERATIONAL_SERVICE", name: "operational_governance.change_requests", kind: "table" },
  { owner: "OPERATIONAL_SERVICE", name: "operational_governance.change_attempts", kind: "table" },
  { owner: "OPERATIONAL_SERVICE", name: "operational_governance.change_verification_evidence", kind: "table" },
  { owner: "OPERATIONAL_SERVICE", name: "operational_governance.maintenance_events", kind: "table" },
