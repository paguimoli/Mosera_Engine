...
const requiredTables = [
  ...
  "game_engine.outcome_provider_configuration_versions",
  "game_engine.outcome_provider_activation_events",
  "game_engine.outcome_provider_executions",
  "game_engine.outcome_provider_execution_attempts",
  "game_engine.outcome_provider_execution_evidence",
...
addCheck("canonical_outcome_authority_model_column", columnExists("game_engine", "canonical_outcome_versions", "authority_model_version"));
addCheck("canonical_outcome_provider_evidence_column", columnExists("game_engine", "canonical_outcome_versions", "provider_evidence_id"));
addCheck("canonical_outcome_game_definition_column", columnExists("game_engine", "canonical_outcome_versions", "game_definition_version_id"));
addCheck("canonical_outcome_certificate_signature_column", columnExists("game_engine", "canonical_outcome_versions", "certificate_signature_id"));
addCheck("canonical_outcome_validated_payload_column", columnExists("game_engine", "canonical_outcome_versions", "validated_outcome_payload"));
addCheck("canonical_outcome_lifecycle_evidence_column", columnExists("game_engine", "canonical_outcome_versions", "lifecycle_evidence_hash"));
addCheck("canonical_outcome_lifecycle_events_table", existsRegclass("game_engine.canonical_outcome_lifecycle_events"));
addCheck("canonical_outcome_lifecycle_draw_index", indexExists("game_engine", "canonical_outcome_lifecycle_events", "idx_canonical_outcome_lifecycle_draw"));
addCheck("canonical_outcome_lifecycle_version_index", indexExists("game_engine", "canonical_outcome_lifecycle_events", "idx_canonical_outcome_lifecycle_version"));
addCheck("canonical_outcome_lifecycle_update_guard", triggerExists("game_engine", "canonical_outcome_lifecycle_events", "trg_prevent_canonical_outcome_lifecycle_event_update"));
...
addCheck("canonical_outcome_certificate_signature_fk", constraintExists("game_engine", "canonical_outcome_versions", "fk_canonical_outcome_certificate_signature"));
addCheck("canonical_outcome_provider_evidence_index", indexExists("game_engine", "canonical_outcome_versions", "idx_canonical_outcome_provider_evidence"));
addCheck("canonical_outcome_manifest_provider_index", indexExists("game_engine", "canonical_outcome_versions", "idx_canonical_outcome_manifest_provider"));
addCheck("canonical_outcome_game_evaluator_index", indexExists("game_engine", "canonical_outcome_versions", "idx_canonical_outcome_game_evaluator"));
