...
namespace LedgerService.Middleware;
...
public sealed class CorrelationIdMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        context.Items[LedgerHeaders.CorrelationId] = correlationId;
    ...
    {
        var headerValue = context.Request.Headers[LedgerHeaders.CorrelationId].FirstOrDefault();
